...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Все изображения - {{ $style->name }}</h1>
                        ...
                        <div class="card images">
                            <div class="img-container">
                                <div class="d-flex justify-content-between align-items-center p-2 first">
                                    <a href="{{ route('img.edit', $image['id']) }}"><span
                                            class="percent bg-success"><i class="fa fa-edit"></i></span></a>
                                ...
                                <img src="/storage/image/styles/{{ $image['name'] }}" class="card-img-top" alt="">
                            </div>
                        </div>
                    </div>
                @endforeach
